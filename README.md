...
<p align="center">
  ...
  <a href="https://github.com/leonardopedro/zentinel/discussions">Discussions</a> •
...
docker run -v $(pwd)/zentinel.kdl:/etc/zentinel/zentinel.kdl \
  ghcr.io/leonardopedro/zentinel --config /etc/zentinel/zentinel.kdl
```
...
- 💬 [Discussions](https://github.com/leonardopedro/zentinel/discussions) — Questions, ideas, show & tell
- 🐛 [Issues](https://github.com/leonardopedro/zentinel/issues) — Bug reports and feature requests
